...
export const BudgetSchema = z.object({
  ...
  amount: z.number().nonnegative({ message: "Amount must be 0 or greater." }),
});
...
export const GoalSchema = z.object({
  ...
  targetAmount: z.number().positive({ message: "Target must be greater than 0." }),
});
...
export function getFieldErrors<T>(issues: z.ZodIssue[]): FieldErrors<T> {
